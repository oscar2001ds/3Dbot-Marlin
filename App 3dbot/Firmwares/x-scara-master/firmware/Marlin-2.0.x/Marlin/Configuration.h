...
#define STRING_CONFIG_H_AUTHOR "Oscar Diaz" // Who made the changes.
...
#define Y_MIN_POS (0-Y_BED_SIZE/2)+10
#define Z_MIN_POS 0
 ...
 *
 *   Caveats: The ending Z should be the same as starting Z.BED_SI
